...
<table><tr>
    ...
    <td>
      <a href="https://github.com/conda-forge/pthread-stubs-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/pthread-stubs-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
...
pixi add pthread-stubs
# for installing globally
pixi global install pthread-stubs
```
...
It is possible to list all of the versions of `pthread-stubs` available on your platform:
...
```
pixi search pthread-stubs --channel conda-forge
```
